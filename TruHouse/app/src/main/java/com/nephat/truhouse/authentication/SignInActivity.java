...
public class SignInActivity extends AppCompatActivity {
   ...
   // private static final String URL_LOGIN = "http://192.168.100.2/realEstate/login.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mAgentLogin = findViewById(R.id.btnEnterAsAgent);
        TextView mLinkRegister = findViewById(R.id.link_reg_text);
        TextView mForgotPass = findViewById(R.id.forgot_pass_text);
        ...
        mSignInBtn.setOnClickListener(v -> performLogin());

        mAgentLogin.setOnClickListener(v -> {
        ...
        mLinkRegister.setOnClickListener(v -> {
