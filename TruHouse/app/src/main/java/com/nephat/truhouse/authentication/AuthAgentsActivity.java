...
public class AuthAgentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mBtnSelectImage = findViewById(R.id.buttonSelectLicence);
        Button mBtnVerifyAgent = findViewById(R.id.buttonVerify);
        ...
        mBtnSelectImage.setOnClickListener(v -> showImageImportDialog());

        mBtnVerifyAgent.setOnClickListener(v -> verifyRegistrationNumber());
    }
